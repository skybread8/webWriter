...
class SiteSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'shipping_price' => ['nullable', 'numeric', 'min:0', 'max:9999.99'],
            ...
            'shipping_price.numeric' => 'El precio de envío debe ser un número válido.',
            'shipping_price.min' => 'El precio de envío no puede ser negativo.',
            'shipping_price.max' => 'El precio de envío no puede ser mayor a 9999.99 €.',
