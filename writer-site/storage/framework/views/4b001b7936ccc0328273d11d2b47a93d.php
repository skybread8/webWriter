...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layout','data' => ['title' => 'Vista previa: '.e($blogPost->title).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Vista previa: '.e($blogPost->title).'']); ?>
    <div class="space-y-8">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <div class="text-xs tracking-[0.25em] uppercase text-zinc-500 mb-2"><?php echo e(__('common.admin.blog')); ?></div>
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="<?php echo e(url('admin/blog/'.$blogPost->getKey().'/edit')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-zinc-100 text-zinc-950 text-sm font-semibold hover:bg-white transition-colors">
                ...
                ?>
                <a href="<?php echo e($publicUrl); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-zinc-600 text-zinc-200 text-sm font-medium hover:bg-zinc-800 transition-colors">
                    Ver en web
                </a>
                <a href="<?php echo e(route('admin.blog.index')); ?>" class="text-zinc-400 hover:text-zinc-100 text-sm underline">
                    <?php echo e(__('common.admin.cancel')); ?>
            ...
            <div class="p-6 sm:p-8 md:p-10 max-w-4xl">
                <header class="mb-8">
                    <div class="text-[11px] tracking-[0.3em] uppercase text-zinc-500 mb-2">
                        <?php echo e($blogPost->published_at ? $blogPost->published_at->format('d/m/Y H:i') : 'Sin fecha'); ?>
                ...
                <?php if($blogPost->featured_image): ?>
                    <figure class="mb-8 rounded-2xl overflow-hidden">
                        <img
                            src="<?php echo e(get_image_url($blogPost->featured_image)); ?>"
                            alt="<?php echo e($blogPost->featured_image_alt ?: $blogPost->title); ?>"
                            class="w-full h-auto object-cover max-h-96"
                        >
                    </figure>
                <?php endif; ?>

                <?php if($blogPost->content): ?>
...
<?php endif; ?>
<?php /**PATH /Users/gerardrevo/Documents/GitHub/WebKevin/writer-site/resources/views/admin/blog/show.blade.php ENDPATH**/ ?>